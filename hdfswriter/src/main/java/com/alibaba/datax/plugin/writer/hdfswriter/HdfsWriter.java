...
public class HdfsWriter extends Writer {
    public static class Job extends Writer.Job {
        ...
        private Boolean haveSuccessFile;
        ...
        private void validateParameter() {
            ...
            if (!supportedWriteModes.contains(writeMode)) {
                throw DataXException.asDataXException(HdfsWriterErrorCode.ILLEGAL_VALUE,
                        String.format("仅支持append, nonConflict,truncate三种模式, 不支持您配置的 writeMode 模式 : [%s]", writeMode));
            }
            ...
            //Kerberos check
            haveKerberos = this.writerSliceConfig.getBool(Key.HAVE_KERBEROS, false);
            if (haveKerberos) {
            ...
            //success file check
            haveSuccessFile = this.writerSliceConfig.getBool(Key.HAVE_SUCCESS_FILE, false);
            if (haveSuccessFile) {
                succFilePath = this.writerSliceConfig.getNecessaryValue(Key.SUCCESS_FILE_PATH, HdfsWriterErrorCode.REQUIRED_VALUE);
            }
            // encoding check
        ...
        public void prepare() {
            ...
            if (hdfsHelper.isPathExists(path)) {
                ...
                //modify by zengli  add truncate模式
                ...
                // modify by zengli 如果路径不存在则修改创建路径
        ...
        public void post() {
            ...
            //若果需要添加成功文件
            if (haveSuccessFile) {
                hdfsHelper.addSucessFile(succFilePath, "");
            }
        }
    ...
    public static class Task extends Writer.Task {
        ...
        public void init() {
            ...
            //得当的已经是绝对路径，eg：hdfs://10.101.204.12:9000/user/hive/warehouse/com.alibaba.datax.plugin.writer.db/text/test.textfile
        ...
        public void startWrite(RecordReceiver lineReceiver) {
            ...
            hdfsHelper.getUgi().doAs((PrivilegedAction<Object>) () -> {
